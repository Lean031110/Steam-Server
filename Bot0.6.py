...
async def help_command(update: Update, context: CallbackContext) -> None:
    keyboard = [
        ...
        [InlineKeyboardButton("Atrás ↩️", callback_data='back')]
    ]
...
async def help_button_handler(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'basic_commands':
        ...
        await start(query.message, context)  # Vuelve al menú principal
    logger.info(f"Usuario seleccionó: {query.data}")
...
async def privacy_policy(update: Update, context: CallbackContext) -> None:
    ...
    logger.info("Usuario solicitó la política de privacidad.")
...
async def manage_group(update: Update, context: CallbackContext) -> None:
    ...
    logger.info("Usuario entró en Administrar Grupo.")
...
async def add_to_group(update: Update, context: CallbackContext) -> None:
    ...
    logger.info("Usuario solicitó añadir el bot a un grupo.")
...
async def what_can_i_do(update: Update, context: CallbackContext) -> None:
    ...
    """)
    logger.info("Usuario solicitó '¿Qué Puedo Hacer?'.")
...
async def train_bot(update: Update, context: CallbackContext) -> None:
    try:
        ...
        logger.info(f"Bot entrenado con la palabra clave: {keyword}")
...
async def button_handler(update: Update, context: CallbackContext) -> None:
    ...
    logger.info(f"Usuario pulsó: {text}")
